<div class="row">
	<div class="four columns">		
		...
		<input class="u-full-width" type="text" name="Surname" id="Surname" placeholder="Фамилия" value="<? echo $row['Surname'] ?>" pattern="[.]{,75}" required>
	</div>
	<div class="four columns">		
		<label for="Name">Имя</label>
		<input class="u-full-width" type="text" name="Name" id="Name" placeholder="Имя" value="<? echo $row['Name'] ?>" pattern="[.]{,75}" required>
	</div>
	<div class="four columns">		
		<label for="Patronymic">Отчество</label>
		<input class="u-full-width" type="text" name="Patronymic" id="Patronymic" placeholder="Отчество" value="<? echo $row['Patronymic'] ?>" pattern="[.]{,75}" required>
	</div>
</div>
